        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Tambah Pencatatan Air</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('pencatatan_air.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="month" id="periode" name="periode" class="form-control @error('periode') is-invalid @enderror" value="{{ old('periode') }}" required>
                            @error('periode')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" step="0.01" id="meter_lalu" name="meter_lalu" class="form-control @error('meter_lalu') is-invalid @enderror" value="{{ old('meter_lalu') }}" required>
                            @error('meter_lalu')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" step="0.01" id="meter_kini" name="meter_kini" class="form-control @error('meter_kini') is-invalid @enderror" value="{{ old('meter_kini') }}" required>
                            @error('meter_kini')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" id="total_tagihan" name="total_tagihan" class="form-control @error('total_tagihan') is-invalid @enderror" value="{{ old('total_tagihan', 0) }}" readonly>
                            @error('total_tagihan')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>

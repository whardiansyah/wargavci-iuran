...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-md-8">
            <h2 class="h3">Edit Penyewa: {{ $penyewa->nama_penyewa }}</h2>
        </div>
    </div>
            ...
            <form action="{{ route('penyewa.update', $penyewa->id) }}" method="POST">
                    ...
                    <select name="master_penghuni_id" id="master_penghuni_id" 
                        ...
                        @foreach ($masterPenghunis as $penghuni)
                            <option value="{{ $penghuni->id }}" 
                                    {{ $penyewa->master_penghuni_id == $penghuni->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_penyewa" id="nama_penyewa" 
                           ...
                           value="{{ old('nama_penyewa', $penyewa->nama_penyewa) }}" placeholder="Masukkan nama penyewa">
                    @error('nama_penyewa')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="tgl_mulai_sewa" id="tgl_mulai_sewa" 
                               ...
                               value="{{ old('tgl_mulai_sewa', $penyewa->tgl_mulai_sewa) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="tgl_selesai_sewa" id="tgl_selesai_sewa" 
                               ...
                               value="{{ old('tgl_selesai_sewa', $penyewa->tgl_selesai_sewa) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="jml_anggota" id="jml_anggota" 
                               ...
                               value="{{ old('jml_anggota', $penyewa->jml_anggota) }}" min="1">
                        @error('jml_anggota')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status" id="status" 
                            ...
                            <option value="tidak aktif" {{ old('status', $penyewa->status) == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror

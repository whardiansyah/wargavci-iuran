        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('master_penghunis.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_rumah') is-invalid @enderror" id="nomor_rumah" name="nomor_rumah" value="{{ old('nomor_rumah') }}" required>
                            @error('nomor_rumah')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status_rumah') is-invalid @enderror" id="status_rumah" name="status_rumah" required>
                                ...
                                <option value="kosong" {{ old('status_rumah') === 'kosong' ? 'selected' : '' }}>Kosong</option>
                            </select>
                            @error('status_rumah')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
